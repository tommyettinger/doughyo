...
public interface IntSortedSet extends IntSet, SortedSet<Integer> {
	/** Returns a type-specific {@link BidirectionalIterator} on the elements in this set, starting from a given element of the domain (optional operation).
	 *
	 ...
	 * {@link BidirectionalIterator#hasNext() hasNext()} will return <code>false</code>). The previous element of the returned iterator is the greatest element of the set that is
	 * smaller than or equal to the starting point (if there are no elements smaller than or equal to the starting point, {@link BidirectionalIterator#hasPrevious()
	 * hasPrevious()} will return <code>false</code>).
	 * 
	 * <P>Note that passing the last element of the set as starting point and calling {@link BidirectionalIterator#previous() previous()} you can traverse the entire set in
	 * reverse order.
	 *
	...
	/** Returns a type-specific {@link BidirectionalIterator} iterator on the collection.
	 *
	...
	/** Returns a type-specific {@link BidirectionalIterator} on the elements in this set.
	 *
