...
public interface IntList extends List<Integer>, Comparable<List<? extends Integer>>, IntCollection {
	 ...
	 *
	 * Note that this specification strengthens the one given in {@link List#iterator()}. It would not be normally necessary, but {@link Iterable#iterator()} is bizarrily re-specified in
	 * {@link List}.
	 *
